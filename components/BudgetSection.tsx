              ...
              <div className="relative">
                ...
                <input
                  ...
                  onChange={e => {
                    ...
                    setLimitDisplay(raw ? formatInput(raw) : '')
                    setForm(f => ({ ...f, limit_amount: parseInput(raw) }))
                  }}
                  placeholder="0"
                  className="w-full border border-gray-200 dark:border-gray-600 rounded-xl pl-8 pr-3 py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-blue-400 bg-white dark:bg-gray-800 dark:text-white dark:placeholder-gray-500"
                />
              </div>
            </div>
          </div>
